 ...
 * GuardedBy
 * 
 * The field or method from which this annotation is applied can only be accessed
 ...
 * from disambiguate 'this'; the class-name.this designation allows you from specify
 * which 'this' reference is intended itself : For reference fields only; the
 * object from which the field refers. field-name : The lock object is referenced
