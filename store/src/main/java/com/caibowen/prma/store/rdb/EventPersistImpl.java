...
// * @since 23-10-2014.
// */
//public class EventPersistImpl extends JdbcSupport implements EventStore {
//
//    @Inject KVStore<String> threadDAO;
//
//    @Inject KVStore<String> loggerDAO;
//
...
//
//
//    public KVStore<String> getThreadDAO() {
//        return threadDAO;
//    }
//
//    public void setThreadDAO(KVStore<String> threadDAO) {
//        this.threadDAO = threadDAO;
//    }
//
//    public KVStore<String> getLoggerDAO() {
//        return loggerDAO;
//    }
//
//    public void setLoggerDAO(KVStore<String> loggerDAO) {
