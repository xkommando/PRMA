...
//* @since 23-10-2014.
//*/
//public class StrDAOImpl extends AbstractInt4DAO<String> implements Int4DAO<String>, Serializable {
//
...
//
//    public StrDAOImpl(String tableName) {
...
//
//    @Override
//    public boolean hasVal(@Nonnull final String value) {
//        return queryForObject(new StatementCreator() {
//            @Nonnull
//            @Override
//            public PreparedStatement createStatement(@Nonnull Connection con) throws SQLException {
